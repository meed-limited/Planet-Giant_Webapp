...
const Dashboard: React.FC = () => {
  ...
  const [nftToTransfer, setNftToTransfer] = useState<NFTinDB | null>(null);
  const [nftToSell, setNftToSell] = useState<NFTinDB | null>(null);
  ...
  const handleTransferClick = (nft: NFTinDB) => {
    setNftToTransfer(nft);
    setVisibilityTransfer(true);
  };

  const handleSellClick = (nft: NFTinDB) => {
    setNftToSell(nft);
